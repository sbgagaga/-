	...
	; Compiler options:
	;
	; -oXLD-DLZFQ-20180105_V1.0.cof -mXLD-DLZFQ-20180105_V1.0.map \
	; --summary=default,-psect,-class --fill=FFFF --output=intel \
	; Display_lcd.p1 AD.p1 XLD-DLZFQ-20180105_V1.0.p1 Kscan.p1 \
	; --chip=SC8P1713S -P --runtime=default,+stackcall --opt=default \
