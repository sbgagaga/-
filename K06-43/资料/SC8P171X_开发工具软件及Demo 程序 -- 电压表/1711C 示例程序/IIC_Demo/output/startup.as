	...
	; Compiler options:
	;
	; -oIIC_DEMO.cof -mIIC_DEMO.map --summary=default,-psect,-class \
	; --fill=FFFF --output=bin IIC_Soft_Master.p1 --chip=SC8P1713 -P \
	; --runtime=default,+stackcall --opt=default -E+cmscerr.err -D__DEBUG=1 \
	; -g --asmlist --errformat=Error[%n]:	%f	第%l行	%s \
