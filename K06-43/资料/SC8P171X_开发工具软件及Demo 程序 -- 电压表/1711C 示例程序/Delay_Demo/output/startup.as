	...
	; Compiler options:
	;
	; -oDelay.cof -mDelay.map --summary=default,-psect,-class --fill=FFFF \
	; --output=bin Delay.p1 --chip=SC8P1713 -P --runtime=default,+stackcall \
	; --opt=default -E+cmscerr.err -D__DEBUG=1 -g --asmlist \
