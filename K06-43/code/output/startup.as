	...
	; Compiler options:
	;
	; -oK06-43.cof -mK06-43.map --summary=default,-psect,-class \
	; --fill=0xFFFF --output=intel main.p1 even.p1 K06-43.p1 ADC.p1 Key.p1 \
	; LED.p1 Motor.p1 Beep.p1 Charge.p1 --chip=SC8P1713S -P \
