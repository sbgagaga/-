	...
	; Compiler options:
	;
	; -oCode_Prj.cof -mCode_Prj.map --summary=default,-psect,-class \
	; --fill=0xFFFF --output=intel main.p1 sc8p1711c.p1 display.p1 Kscan.p1 \
	; AppProc.p1 --chip=SC8P1713S -P --runtime=default, \
